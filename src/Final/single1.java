...
public class single1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Click on Start Button to Play Againest Computer by Keyboard");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 150, 630, 50);
        ...
        jButton2.setBounds(240, 420, 106, 40);
    ...
    public static void main(String args[])throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(single1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
